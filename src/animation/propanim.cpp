                                             ...
                                             int t_launch)
{
  ...
  {
    auto animRotX = dwellClubSelfRotXAnim(t_launch);
...
QSequentialAnimationGroup *PropAnim::dwellClubSelfRotXAnim(const int t_launch)
{
  ...
  {
    midAngleRotX = finalRotX + CLUB_DWELL_X_DECAY; // NOTE: is it good for a passed club ?
  }
